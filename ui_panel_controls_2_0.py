...
################# BLENRIG PICKER BODY #############################################
            if bpy.context.mode == "POSE":
                ...
                if "gui_picker_body" in arm and arm["gui_picker_body"]:
                    ...
                    if props.gui_picker_body_picker:
                        ...
                        if props.gui_picker_body_props:
                            ...
                            row_switch.operator("show.look_list", text="{}".format("      Free      " if arm_bones['properties_head']['look_switch'] == 0
                            else ("Follow Body" if arm_bones['properties_head']['look_switch'] == 1
                            else ("Follow Torso" if arm_bones['properties_head']['look_switch'] == 2
                            else "Follow Head"))), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                            col_prop.prop(arm_bones['properties_head'], 'look_switch', toggle=True, icon_only = 1, emboss = 1)
                        ...
                        if props.gui_picker_body_props:
                            ...
                            row_pivot.operator("reset.master_torso_pivot", text='Reset Pivot', icon='PIVOT_CURSOR', emboss=True)
                    ...
                    # View
                        ...
                        # Sliders_R
                            ...
                            row_switch.scale_y = 1
                            row_switch.operator("show.head_list", text="{}".format("      Free      " if arm_bones['properties_head']['space_head'] == 0 else "Follow Torso"), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                            col_prop.prop(arm_bones['properties_head'], 'space_head', toggle=True, icon_only = 1, emboss = 1)
                            ...
                            row_neck_switch.operator("show.neck_list", text="{}".format("      Free      " if arm_bones['properties_head']['space_neck'] == 0 else "Follow Torso"), emboss=True)
                            col_prop = row_neck_switch.column(align=True)
                            col_prop.scale_x = 0.5
                            col_prop.prop(arm_bones['properties_head'], 'space_neck', toggle=True, icon_only = 1, emboss = 1)
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.arm_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_arm_R'] == 0
                            else ("Follow Pelvis" if arm_bones['properties_arm_R']['space_arm_R'] == 1
                            else ("Follow Torso" if arm_bones['properties_arm_R']['space_arm_R'] == 2
                            else "Follow Head"))), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.arm_pole_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_arm_ik_pole_R'] == 0 else "Follow Torso"), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                            ...
                            row_hand.scale_y = 1
                            row_hand.operator("show.hand_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_hand_R'] == 0 else "Follow Arm"), emboss=True)
                            col_prop = row_hand.column(align=True)
                            col_prop.scale_x = 0.5
                            col_prop.prop(arm_bones['properties_arm_R'], 'space_hand_R', toggle=True, icon_only = 1, emboss = 1)
                            row_pivot = col_sliders_R.row(align=True)
                            row_pivot.alignment = 'CENTER'
                            row_pivot.scale_x = 2.8
                            row_pivot.scale_y = 1.2
                            row_pivot.operator("reset.hand_r_pivot", text='Reset Pivot', icon='PIVOT_CURSOR', emboss=True)
                            ...
                            row_fing.scale_y = 1
                            row_fing.operator("show.fing_all_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_fing_all_R'] == 0 else "Follow Hand"), emboss=True)
                            col_prop = row_fing.column(align=True)
                            col_prop.scale_x = 0.5
                            col_prop.prop(arm_bones['properties_arm_R'], 'space_fing_thumb_R', toggle=True, icon_only = 1, emboss = 1)
                            row_prop = col_sliders_R.row(align=True)
                            row_prop.scale_y = 1
                            row_prop.scale_x = 0.8
                            row_prop.prop(arm_bones['properties_arm_R'], 'space_fing_lit_R', toggle=True, icon_only = 1, emboss = 1)
                            row_prop.prop(arm_bones['properties_arm_R'], 'space_fing_ring_R', toggle=True, icon_only = 1, emboss = 1)
                            row_prop.prop(arm_bones['properties_arm_R'], 'space_fing_mid_R', toggle=True, icon_only = 1, emboss = 1)
                            row_prop.prop(arm_bones['properties_arm_R'], 'space_fing_ind_R', toggle=True, icon_only = 1, emboss = 1)
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.leg_list_r", text="{}".format("      Free      " if arm_bones['properties_leg_R']['space_leg_R'] == 0 else "Follow Torso"), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.6
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.leg_pole_list_r", text="{}".format("      Free      " if arm_bones['properties_leg_R']['space_leg_ik_pole_R'] == 0
                            else ("Follow Torso" if arm_bones['properties_leg_R']['space_leg_ik_pole_R'] == 1 else "Follow Foot")), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                        ...
                        # Sliders_L
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.arm_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_arm_L'] == 0
                            else ("Follow Pelvis" if arm_bones['properties_arm_L']['space_arm_L'] == 1
                            else ("Follow Torso" if arm_bones['properties_arm_L']['space_arm_L'] == 2
                            else "Follow Head"))), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.arm_pole_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_arm_ik_pole_L'] == 0 else "Follow Torso"), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                            ...
                            row_hand.scale_x = 2.5
                            row_hand.scale_y = 1
                            row_hand.operator("show.hand_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_hand_L'] == 0 else "Follow Arm"), emboss=True)
                            col_prop = row_hand.column(align=True)
                            col_prop.scale_x = 0.5
                            col_prop.prop(arm_bones['properties_arm_L'], 'space_hand_L', toggle=True, icon_only = 1, emboss = 1)
                            row_pivot = col_sliders_L.row(align=True)
                            row_pivot.alignment = 'CENTER'
                            row_pivot.scale_x = 2.8
                            row_pivot.scale_y = 1.2
                            row_pivot.operator("reset.hand_l_pivot", text='Reset Pivot', icon='PIVOT_CURSOR', emboss=True)
                            ...
                            col_prop = row_fing.column(align=True)
                            col_prop.scale_x = 0.5
                            col_prop.prop(arm_bones['properties_arm_L'], 'space_fing_thumb_L', toggle=True, icon_only = 1, emboss = 1)
                            row_fing.operator("show.fing_all_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_fing_all_L'] == 0 else "Follow Hand"), emboss=True)
                            row_prop = col_sliders_L.row(align=True)
                            row_prop.scale_y = 1
                            row_prop.scale_x = 0.8
                            row_prop.prop(arm_bones['properties_arm_L'], 'space_fing_ind_L', toggle=True, icon_only = 1, emboss = 1)
                            row_prop.prop(arm_bones['properties_arm_L'], 'space_fing_mid_L', toggle=True, icon_only = 1, emboss = 1)
                            row_prop.prop(arm_bones['properties_arm_L'], 'space_fing_ring_L', toggle=True, icon_only = 1, emboss = 1)
                            row_prop.prop(arm_bones['properties_arm_L'], 'space_fing_lit_L', toggle=True, icon_only = 1, emboss = 1)
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.leg_list_l", text="{}".format("      Free      " if arm_bones['properties_leg_L']['space_leg_L'] == 0 else "Follow Torso"), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.6
                            ...
                            row_switch.scale_x = 2.5
                            row_switch.scale_y = 1
                            row_switch.operator("show.leg_pole_list_l", text="{}".format("      Free      " if arm_bones['properties_leg_L']['space_leg_ik_pole_L'] == 0
                            else ("Follow Torso" if arm_bones['properties_leg_L']['space_leg_ik_pole_L'] == 1 else "Follow Foot")), emboss=True)
                            col_prop = row_switch.column(align=True)
                            col_prop.scale_x = 0.5
                        ...
                        col_head.prop(arm_bones['properties_head'], 'space_head', text="{}".format("Free" if arm_bones['properties_head']['space_head'] == 0 else "Follow Torso"), toggle=True, icon_only = 1, emboss = 1)
                        col_head.label(text="NECK")
                        col_head.prop(arm_bones['properties_head'], 'space_neck', text="{}".format("Free" if arm_bones['properties_head']['space_neck'] == 0 else "Follow Torso"), toggle=True, icon_only = 1, emboss = 1)
                ...
                # collapsed box
                    ...
                    row.operator("gui.blenrig_5_tabs", icon="MOD_ARMATURE", emboss = 1).tab = "gui_picker_body"
                    row.label(text="BODY PICKER & PROPERTIES")
...
################ FACE #######################################
            if bpy.context.mode == "POSE":
                ...
                if "gui_picker_face" in arm and arm["gui_picker_face"]:
                    row.operator("gui.blenrig_5_tabs", icon="MONKEY", emboss = 1).tab = "gui_picker_face"
            ...
            if bpy.context.mode == "POSE":
                ...
                # Fingers
                    ...
                    if props.gui_extra_props_fingers:
                        ...
                        row_thumb.scale_y = 1
                        row_thumb.operator("show.fing_thumb_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_fing_thumb_R'] == 0 else "Follow Hand"), emboss=True)
                        ...
                        row_ind.scale_x = 2.5
                        row_ind.scale_y = 1
                        row_ind.operator("show.fing_ind_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_fing_ind_R'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_ind.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_R'], 'space_fing_ind_R', toggle=True, icon_only = 1, emboss = 1)
                        row_mid = col_3.row(align=True)
                        row_mid.alignment = 'CENTER'
                        row_mid.scale_x = 2.5
                        row_mid.scale_y = 1
                        row_mid.operator("show.fing_mid_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_fing_mid_R'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_mid.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_R'], 'space_fing_mid_R', toggle=True, icon_only = 1, emboss = 1)
                        row_ring = col_3.row(align=True)
                        row_ring.alignment = 'CENTER'
                        row_ring.scale_x = 2.5
                        row_ring.scale_y = 1
                        row_ring.operator("show.fing_ring_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_fing_ring_R'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_ring.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_R'], 'space_fing_ring_R', toggle=True, icon_only = 1, emboss = 1)
                        row_lit = col_3.row(align=True)
                        row_lit.alignment = 'CENTER'
                        row_lit.scale_x = 2.5
                        row_lit.scale_y = 1
                        row_lit.operator("show.fing_lit_list_r", text="{}".format("      Free      " if arm_bones['properties_arm_R']['space_fing_lit_R'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_lit.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_R'], 'space_fing_lit_R', toggle=True, icon_only = 1, emboss = 1)
                        row_thumb = col_5.row(align=True)
                        row_thumb.alignment = 'CENTER'
                        row_thumb.scale_x = 2.5
                        row_thumb.scale_y = 1
                        row_thumb.operator("show.fing_thumb_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_fing_thumb_L'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_thumb.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_L'], 'space_fing_thumb_L', toggle=True, icon_only = 1, emboss = 1)
                        ...
                        row_ind.scale_x = 2.5
                        row_ind.scale_y = 1
                        row_ind.operator("show.fing_ind_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_fing_ind_L'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_ind.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_L'], 'space_fing_ind_L', toggle=True, icon_only = 1, emboss = 1)
                        row_mid = col_5.row(align=True)
                        row_mid.alignment = 'CENTER'
                        row_mid.scale_x = 2.5
                        row_mid.scale_y = 1
                        row_mid.operator("show.fing_mid_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_fing_mid_L'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_mid.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_L'], 'space_fing_mid_L', toggle=True, icon_only = 1, emboss = 1)
                        row_ring = col_5.row(align=True)
                        row_ring.alignment = 'CENTER'
                        row_ring.scale_x = 2.5
                        row_ring.scale_y = 1
                        row_ring.operator("show.fing_ring_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_fing_ring_L'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_ring.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_L'], 'space_fing_ring_L', toggle=True, icon_only = 1, emboss = 1)
                        row_lit = col_5.row(align=True)
                        row_lit.alignment = 'CENTER'
                        row_lit.scale_x = 2.5
                        row_lit.scale_y = 1
                        row_lit.operator("show.fing_lit_list_l", text="{}".format("      Free      " if arm_bones['properties_arm_L']['space_fing_lit_L'] == 0 else "Follow Hand"), emboss=True)
                        col_prop = row_lit.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_arm_L'], 'space_fing_lit_L', toggle=True, icon_only = 1, emboss = 1)
                    ...
                    if props.gui_extra_props_props:
                        ...
                        row_hat.scale_x = 2.5
                        row_hat.scale_y = 1
                        row_hat.operator("show.hat_list", text="{}".format("      Free      " if arm_bones['properties_head']["hat_free"] == 0 else "Follow Head"), emboss=True)
                        ...
                        row_eyeglasses.operator("show.eyeglasses_list", text="{}".format("      Free      " if arm_bones['properties_head']["glasses_free"] == 0 else "Follow Head"), emboss=True)
                        col_prop = row_eyeglasses.column(align=True)
                        col_prop.scale_x = 0.25
                        col_prop.prop(arm_bones['properties_head'], '["glasses_free"]', toggle=True, icon_only = 1, emboss = 1)
                        ...
                        col_prop2.prop(arm_bones['properties_arm_R'], '["hand_accessory_R"]', toggle=True, icon_only = 1, emboss = 1)
