            ...
            if bpy.context.mode == "POSE":
                ...
                if "gui_picker_body" in arm and arm["gui_picker_body"]:
                    ...
                    if props.gui_picker_body_picker:
                        ...
                        col_foot_ctrl_L.operator("operator.foot_l", text="Foot R")
            ...
            if bpy.context.mode == "POSE":
                ...
                if "gui_misc" in arm and arm["gui_misc"]:
                    ...
                    if props.gui_extra_props_arms:                        
                        ...
                        col_2.scale_y = 1
                        col_2.alignment = 'CENTER'
                        col_1.prop(arm_bones['properties_arm_R'], 'toggle_arm_ik_pole_R', text="Toggle Right Arm Pole")                             
                        col_1.prop(arm_bones['properties_arm_R'], 'space_arm_ik_pole_R', text="Follow_Torso_R", toggle=True, icon_only = 1, emboss = 1)
                        col_2.prop(arm_bones['properties_arm_L'], 'toggle_arm_ik_pole_L', text="Toggle Left Arm Pole")                            
                        col_2.prop(arm_bones['properties_arm_L'], 'space_arm_ik_pole_L', text="Follow_Torso_L", toggle=True, icon_only = 1, emboss = 1) 
                        arms_col.separator()                 
                ...
                # Fingers
                    ...
                    if props.gui_extra_props_fingers:
                        ...
                        col_3.scale_y = 1
                        col_3.alignment = 'CENTER'  
                        col_3.label(text='FINGERS_R FREE / FOLLOW')                                  
                        col_5 = hands_row.column()   
                        col_5.scale_x = 1
                        col_5.scale_y = 1
                        col_5.alignment = 'CENTER'   
                        col_5.label(text='FINGERS_L FREE / FOLLOW')                
                        col_1.separator()
                        col_1.separator()  
                        col_1.separator()                     
                    ...
                    if props.gui_extra_props_legs:                    
                        ...
                        col_2.scale_y = 1
                        col_2.alignment = 'CENTER'                           
                        col_1.prop(arm_bones['properties_leg_R'], 'toggle_leg_ik_pole_R', text="Toggle Right Leg Pole")                             
                        col_1.prop(arm_bones['properties_leg_R'], 'space_leg_ik_pole_R', text="Follow_Torso_R", toggle=True, icon_only = 1, emboss = 1)
                        col_2.prop(arm_bones['properties_leg_L'], 'toggle_leg_ik_pole_L', text="Toggle Left Leg Pole")                            
                        col_2.prop(arm_bones['properties_leg_L'], 'space_leg_ik_pole_L', text="Follow_Torso_L", toggle=True, icon_only = 1, emboss = 1) 
                        legs_col.separator()                                     
