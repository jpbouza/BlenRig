...
def edit_action(operator, context, step_name, frame_bone_1, frame_bone_2, view, action, frame_number, bone_list, active_bone, layer_list):
    #reset context show bones
    context.scene.blenrig_guide.guide_show_def_bones = False
    context.scene.blenrig_guide.guide_show_wp_bones = False
    
    #Perform end of step action and set current step name
    end_of_step_action(context)
    context.scene.blenrig_guide.guide_current_step = step_name
    ...
    context.preferences.edit.use_keyframe_insert_available = True
...
def actions_end_generic(context):
    ...
    #Turn Layers off
    on_layers = [0, 1, 3, 4, 5, 6, 7, 8, 9, 10, 12, 14, 15, 17]
